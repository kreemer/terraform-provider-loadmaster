...
func TestOwaspCustomRuleDataSource(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Read testing
			{
				Config: testOwaspCustomRuleDataSourceConfig,
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownValue(
						"data.loadmaster_owasp_custom_rule.test",
...
const testOwaspCustomRuleDataSourceConfig = `
...
data "loadmaster_owasp_custom_rule" "test" {
  filename = loadmaster_owasp_custom_rule.test_rule.filename
}
`
