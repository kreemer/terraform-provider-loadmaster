...
func NewOwaspCustomRuleDataSource() datasource.DataSource {
	return &OwaspCustomRuleDataSource{}
}
...
func (d *OwaspCustomRuleDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_owasp_custom_rule"
}

func (d *OwaspCustomRuleDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *OwaspCustomRuleDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
