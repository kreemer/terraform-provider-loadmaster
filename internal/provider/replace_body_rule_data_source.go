...
func NewReplaceBodyRuleDataSource() datasource.DataSource {
	return &ReplaceBodyRuleDataSource{}
}
...
type ReplaceBodyRuleDataSourceModel struct {
...
func (d *ReplaceBodyRuleDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_replace_body_rule"
}

func (d *ReplaceBodyRuleDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Use this data source to retrieve information about a replace body rule.",
...
func (d *ReplaceBodyRuleDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ReplaceBodyRuleDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data ReplaceBodyRuleDataSourceModel
